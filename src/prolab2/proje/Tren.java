...
public class Tren extends javax.swing.JFrame {
    ...
    public Tren(Map<Integer, Passenger> rezerveEdilmisKoltuklar, int secimSayisi) {
            ...
            if (rezerveEdilmisKoltuklar.get(Integer.parseInt(button.getText())) != null) {
                ...
                button.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (rezerveEdilmisKoltuklar.get(Integer.parseInt(button.getText())) != null) {
                            JOptionPane.showMessageDialog(Tren.this, "Bu koltuk daha önce rezerve edilmiş.", "Uyarı", JOptionPane.WARNING_MESSAGE);
                        } else {
